...
class StoreCertificationRequest extends FormRequest
{
    ...
    {
        return [
            'title.required'    => 'Le titre de la certification est obligatoire.',
            'provider.required' => 'L\'organisme émetteur est obligatoire.',
            'issue_date.required' => 'La date d\'obtention est obligatoire.',
